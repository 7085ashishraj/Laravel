...
//     session(["username" => "Ashish", "email" => "ashish123@yahoo.com", "course" => "Laravel"]);
//     return "Session Set";
// });
...
//     return "Username: " . $username . " Email: " . $email . " Course: " . $course;
// });

// //Session-Delete
// Route::get("deletesession", function(Request $request){
//     $request->session()->forget(["username", "email", "course"]);
...
//store session value 1st method
...
//Set multiple session value
Route::get('setsessionmultivalue', function(){
    session(["name" => "LPU",
            "city" => "Jalandhar",
            "Phone" => "1234567890"]);
    return "Session Set";
...
//2
Route::get('setsessionmultivalue1', function(){
    session()->put("Course", "Laravel");
    session()->put("Section", "423YG");
    session()->put("totalStudent", "69");
});

//only

Route::get('/getsessionvalueonly', function(){
    return session()->only(["Course", "Phone", "section"]);
});

//Except Method

Route::get('/getsessionvalueexcept', function(){
    return session()->except(["Course", "Phone", "section"]);
});
